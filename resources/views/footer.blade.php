        ...
        <div class="mx-auto w-full max-w-screen-xl">
            <div class="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
                ...
                <div>
                    ...
                    <ul class="text-gray-500 dark:text-gray-400 font-medium">
                        <li class="mb-4 flex hover:text-teal-400">
                        ...
                        <li class="mb-4 flex  hover:text-teal-400">
                            ...
                            <a href="#" class="hover:underline">Talk Of The Town</a>
                        </li>
                        <li class="mb-4 flex  hover:text-teal-400">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                                <path stroke-linecap="round" stroke-linejoin="round" d="m5.25 4.5 7.5 7.5-7.5 7.5m6-15 7.5 7.5-7.5 7.5" />
                        ...
                        <li class="mb-4 flex  hover:text-teal-400">
                            ...
                            <a href="#" class="hover:underline">Conatct Us</a>
                        </li>
                        <li class="mb-4 flex  hover:text-teal-400">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                                <path stroke-linecap="round" stroke-linejoin="round" d="m5.25 4.5 7.5 7.5-7.5 7.5m6-15 7.5 7.5-7.5 7.5" />
                ...
                <div>
                    ...
                    <ul class="text-gray-500 dark:text-gray-400 font-medium">
                        <li class="mb-4 flex gap-3">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class=" flex mt-3 rounded-full  bg-white  size-9 font-black text-teal-600  p-2">
                            ...
                            <div class=" flex flex-col">
                                ...
                                <a href="" class=" hover:text-teal-500">+91 7091059106</a>
